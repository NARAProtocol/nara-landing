...
export const GRID_ADDRESSES = {
  naraToken: "0x91FB78A9F46B67f54BbD4489941d19666b2fAe0f",
...
export const DURATION_HORIZONS = [
  { label: "1 Day", shortLabel: "1D", epochs: 96, multiplier: "1.00X", title: "96 Epochs", days: 1 },
  { label: "30 Days", shortLabel: "30D", epochs: 2880, multiplier: "1.06X", title: "2,880 Epochs", days: 30 },
  { label: "90 Days", shortLabel: "90D", epochs: 8640, multiplier: "1.28X", title: "8,640 Epochs", days: 90 },
  { label: "180 Days", shortLabel: "180D", epochs: 17280, multiplier: "1.85X", title: "17,280 Epochs", days: 180 },
  { label: "365 Days", shortLabel: "365D", epochs: 35040, multiplier: "4.00X", title: "35,040 Epochs", days: 365 },
] as const;

/**
 * Computes exact on-chain participation weight multiplier from NARAEngineModelLib.computeWeight:
 * r = dur / maxLockEpochs (35040)
 * multiplier = 1 + 0.5 * r + 2.5 * r^2
 */
export function computeOnchainWeightMultiplier(durationEpochs: number): number {
  const maxLockEpochs = 35040;
  const boundedEpochs = Math.min(Math.max(durationEpochs, 0), maxLockEpochs);
  const r = boundedEpochs / maxLockEpochs;
  return 1.0 + 0.5 * r + 2.5 * (r * r);
}
...
export const SAMPLE_POSITIONS: PositionNftItem[] = [
  {
    tokenId: ethers.BigNumber.from(65),
    positionId: ethers.BigNumber.from(94),
    owner: "0x0000000000000000000000000000000000000000",
    account: "0x0000000000000000000000000000000000000000",
    amount: ethers.utils.parseEther("4950"),
    createdEpoch: 3340,
    unlockEpoch: 38380,
    weight: ethers.utils.parseEther("27225"), // 4,950 * 5.50X = 27,225.00 Effective Weight
    claimableEth: ethers.utils.parseEther("0.1240"),
    claimableNara: ethers.utils.parseEther("185.50"),
    tokenUri: "",
    name: "NARA Position #65",
    description: "4,950 NARA Committed for 365 Days (Forged Damascus Meteorite · Apex 5.50X)",
    imageSvg: "",
    attributes: [
      { trait_type: "Chassis Alloy", value: "Forged Damascus Meteorite (Legendary)" },
      { trait_type: "Effective Staking Power", value: "5.50X" },
      { trait_type: "Base Lock Multiplier", value: "4.00X" },
      { trait_type: "Time Commitment", value: "365 Days" },
      { trait_type: "Locked Principal (NARA)", value: 4950 },
    ],
    isSample: true,
  },
  {
    tokenId: ethers.BigNumber.from(64),
    positionId: ethers.BigNumber.from(93),
    owner: "0x0000000000000000000000000000000000000000",
    account: "0x0000000000000000000000000000000000000000",
    amount: ethers.utils.parseEther("4950"),
    createdEpoch: 3340,
    unlockEpoch: 20620,
    weight: ethers.utils.parseEther("10197"),
    claimableEth: ethers.utils.parseEther("0.0520"),
    claimableNara: ethers.utils.parseEther("82.00"),
    tokenUri: "",
    name: "NARA Position #64",
    description: "4,950 NARA Committed for 180 Days (Cybernetic Emerald)",
    imageSvg: "",
    attributes: [
      { trait_type: "Chassis Alloy", value: "Cybernetic Emerald (Uncommon)" },
      { trait_type: "Effective Staking Power", value: "2.06X" },
      { trait_type: "Base Lock Multiplier", value: "2.06X" },
      { trait_type: "Time Commitment", value: "180 Days" },
      { trait_type: "Locked Principal (NARA)", value: 4950 },
    ],
    isSample: true,
  },
  {
    tokenId: ethers.BigNumber.from(63),
    positionId: ethers.BigNumber.from(92),
    owner: "0x0000000000000000000000000000000000000000",
    account: "0x0000000000000000000000000000000000000000",
    amount: ethers.utils.parseEther("990"),
    createdEpoch: 3330,
    unlockEpoch: 11970,
    weight: ethers.utils.parseEther("1326.6"),
    claimableEth: ethers.utils.parseEther("0.0075"),
    claimableNara: ethers.utils.parseEther("12.40"),
    tokenUri: "",
    name: "NARA Position #63",
    description: "990 NARA Committed for 90 Days (Titanium Slate)",
    imageSvg: "",
    attributes: [
      { trait_type: "Chassis Alloy", value: "Titanium Slate (Common)" },
      { trait_type: "Effective Staking Power", value: "1.34X" },
      { trait_type: "Base Lock Multiplier", value: "1.34X" },
      { trait_type: "Time Commitment", value: "90 Days" },
      { trait_type: "Locked Principal (NARA)", value: 990 },
    ],
    isSample: true,
  },
  {
    tokenId: ethers.BigNumber.from(60),
    positionId: ethers.BigNumber.from(89),
    owner: "0x0000000000000000000000000000000000000000",
    account: "0x0000000000000000000000000000000000000000",
    amount: ethers.utils.parseEther("495"),
    createdEpoch: 3320,
    unlockEpoch: 38360,
    weight: ethers.utils.parseEther("1980"),
    claimableEth: ethers.utils.parseEther("0.0150"),
    claimableNara: ethers.utils.parseEther("22.80"),
    tokenUri: "",
    name: "NARA Position #60",
    description: "495 NARA Committed for 365 Days (Obsidian Void)",
    imageSvg: "",
    attributes: [
      { trait_type: "Chassis Alloy", value: "Obsidian Void (Rare)" },
      { trait_type: "Effective Staking Power", value: "4.00X" },
      { trait_type: "Base Lock Multiplier", value: "4.00X" },
      { trait_type: "Time Commitment", value: "365 Days" },
      { trait_type: "Locked Principal (NARA)", value: 495 },
    ],
    isSample: true,
  },
  {
    tokenId: ethers.BigNumber.from(24),
    positionId: ethers.BigNumber.from(48),
    owner: "0x0000000000000000000000000000000000000000",
    account: "0x0000000000000000000000000000000000000000",
    amount: ethers.utils.parseEther("396"),
    createdEpoch: 3200,
    unlockEpoch: 6080,
    weight: ethers.utils.parseEther("419.76"),
    claimableEth: ethers.utils.parseEther("0.0035"),
    claimableNara: ethers.utils.parseEther("5.20"),
    tokenUri: "",
    name: "NARA Position #24",
    description: "396 NARA Committed for 30 Days (Cybernetic Emerald)",
    imageSvg: "",
    attributes: [
      { trait_type: "Chassis Alloy", value: "Cybernetic Emerald (Uncommon)" },
      { trait_type: "Effective Staking Power", value: "1.06X" },
      { trait_type: "Base Lock Multiplier", value: "1.06X" },
      { trait_type: "Time Commitment", value: "30 Days" },
      { trait_type: "Locked Principal (NARA)", value: 396 },
    ],
    isSample: true,
  },
  {
    tokenId: ethers.BigNumber.from(26),
    positionId: ethers.BigNumber.from(50),
    owner: "0x0000000000000000000000000000000000000000",
    account: "0x0000000000000000000000000000000000000000",
    amount: ethers.utils.parseEther("141.57"),
    createdEpoch: 3200,
    unlockEpoch: 38240,
    weight: ethers.utils.parseEther("566.28"),
    claimableEth: ethers.utils.parseEther("0.0055"),
    claimableNara: ethers.utils.parseEther("9.80"),
    tokenUri: "",
    name: "NARA Position #26",
    description: "141.57 NARA Committed for 365 Days (Cybernetic Emerald)",
    imageSvg: "",
    attributes: [
      { trait_type: "Chassis Alloy", value: "Cybernetic Emerald (Uncommon)" },
      { trait_type: "Effective Staking Power", value: "4.00X" },
      { trait_type: "Base Lock Multiplier", value: "4.00X" },
      { trait_type: "Time Commitment", value: "365 Days" },
      { trait_type: "Locked Principal (NARA)", value: 141.57 },
    ],
    isSample: true,
  },
  {
    tokenId: ethers.BigNumber.from(25),
    positionId: ethers.BigNumber.from(49),
    owner: "0x0000000000000000000000000000000000000000",
    account: "0x0000000000000000000000000000000000000000",
    amount: ethers.utils.parseEther("121.77"),
    createdEpoch: 3200,
    unlockEpoch: 38240,
    weight: ethers.utils.parseEther("487.08"),
    claimableEth: ethers.utils.parseEther("0.0040"),
    claimableNara: ethers.utils.parseEther("8.20"),
    tokenUri: "",
    name: "NARA Position #25",
    description: "121.77 NARA Committed for 365 Days (24K Gilded Gold)",
    imageSvg: "",
    attributes: [
      { trait_type: "Chassis Alloy", value: "24K Gilded Gold (Apex Grail)" },
      { trait_type: "Effective Staking Power", value: "4.00X" },
      { trait_type: "Base Lock Multiplier", value: "4.00X" },
      { trait_type: "Time Commitment", value: "365 Days" },
      { trait_type: "Locked Principal (NARA)", value: 121.77 },
    ],
    isSample: true,
  },
  {
    tokenId: ethers.BigNumber.from(59),
    positionId: ethers.BigNumber.from(88),
    owner: "0x0000000000000000000000000000000000000000",
    account: "0x0000000000000000000000000000000000000000",
    amount: ethers.utils.parseEther("99"),
    createdEpoch: 3300,
    unlockEpoch: 36180,
    weight: ethers.utils.parseEther("105"),
    claimableEth: ethers.utils.parseEther("0.0015"),
    claimableNara: ethers.utils.parseEther("3.10"),
    tokenUri: "",
    name: "NARA Position #59",
    description: "99 NARA Committed for 30 Days (Titanium Slate)",
    imageSvg: "",
    attributes: [
      { trait_type: "Chassis Alloy", value: "Titanium Slate (Common)" },
      { trait_type: "Effective Staking Power", value: "1.06X" },
      { trait_type: "Base Lock Multiplier", value: "1.06X" },
      { trait_type: "Time Commitment", value: "30 Days" },
      { trait_type: "Locked Principal (NARA)", value: 99 },
    ],
    isSample: true,
  },
];
